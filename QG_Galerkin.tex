...
If we define a vector $\bar{\bm{u}}$ whose elements are $\bar u(z_k)$, the the diagonal elements of $\bar{\mat{Q}}_{y,FD}$ are the elements of the vector $-\mat{L}_{FD}\bar{\bm{u}}$.
