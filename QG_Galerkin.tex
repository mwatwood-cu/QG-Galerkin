...
We will do a version of the ocean-Charney problem with only eastward-sheared Charney-type instability (no Phillips-type).
This problem is interesting and a nice complement to the Eady problem because the instability has a long-wave cutoff but no short-wave cutoff (exactly the opposite of Eady).
We will use
\[\beta = 1, \quad\bar u(z) =2z^2,\quad\bar q = -4y,\quad\bar\vartheta^-=0,\quad\bar\vartheta^+=-4y.\]
